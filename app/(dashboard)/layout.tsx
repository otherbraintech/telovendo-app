    ...
    <SidebarProvider>
      <div className="flex min-h-screen w-full bg-background text-foreground font-sans selection:bg-blue-500/30">
        ...
        <SidebarInset className="bg-transparent">
          <header className="flex h-14 lg:h-16 shrink-0 items-center justify-between gap-2 border-b border-blue-500/10 px-4 lg:px-6 bg-background/80 backdrop-blur-md sticky top-0 z-50">
