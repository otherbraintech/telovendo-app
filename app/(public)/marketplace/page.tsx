          ...
          <div className="flex items-center gap-3 w-full md:w-auto">
             <div className="relative flex-grow md:flex-grow-0">
               ...
               <input 
                 ...
                 className="w-full md:w-64 bg-neutral-50 dark:bg-white/5 border border-border/50 rounded-none py-2.5 pl-10 pr-4 text-xs focus:border-blue-500 outline-none transition-all"
               />
             </div>
